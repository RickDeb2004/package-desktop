      ...
      <div className="space-y-4">
        <div className="space-y-2">
          <h2 className="text-2xl font-semibold">
            Search results for articles published on the selected date
          </h2>
        </div>
        <div className="space-y-4">
          <Card>
            <CardHeader className="p-4">
              <div className="grid grid-cols-2 items-center gap-4">
                <div className="text-xl font-bold">Article 1</div>
                <div className="text-sm text-right">2 min read</div>
              </div>
            </CardHeader>
            <CardContent className="p-4">
              <p>
                This is a sample article. It contains information about various
                topics.
              </p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="p-4">
              <div className="grid grid-cols-2 items-center gap-4">
                <div className="text-xl font-bold">Article 2</div>
                <div className="text-sm text-right">3 min read</div>
              </div>
            </CardHeader>
            <CardContent className="p-4">
              <p>
                This is another sample article. It contains information about
                different topics.
              </p>
            </CardContent>
          </Card>
